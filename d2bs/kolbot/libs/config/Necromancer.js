...
function LoadConfig () {
  ...
  */
   ...
   * GOOD: Config.AttackSkill[1] = [sdk.skills.BoneSpear, 0];   // cast BoneSpear using main hand slot
   * GOOD: Config.AttackSkill[1] = [sdk.skills.PoisonNova, 1];  // cast PoisonNova using swap slot
   * GOOD: Config.AttackSkill[1] = [84, 0];                     // numeric skillId with explicit slot
   * NOTE: Single number format (e.g. = 84) still works and defaults to main hand slot (slot 0).
   */
