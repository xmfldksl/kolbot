...
function LoadConfig () {
  ...
  */
   ...
   * GOOD: Config.AttackSkill[1] = [sdk.skills.Smite, 0];       // cast Smite using main hand slot
   * GOOD: Config.AttackSkill[1] = [sdk.skills.HolyBolt, 1];    // cast HolyBolt using swap slot
   * GOOD: Config.AttackSkill[1] = [97, 0];                     // numeric skillId with explicit slot
   * NOTE: Single number format (e.g. = 97) still works and defaults to main hand slot (slot 0).
   */
