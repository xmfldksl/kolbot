...
function LoadConfig () {
  ...
  */
   ...
   * GOOD: Config.AttackSkill[1] = [sdk.skills.Meteor, 0];   // cast Meteor using main hand slot
   * GOOD: Config.AttackSkill[1] = [sdk.skills.FrostNova, 1]; // cast Frost Nova using swap slot
   * GOOD: Config.AttackSkill[1] = [56, 0];                  // numeric skillId with explicit slot
   * NOTE: Single number format (e.g. = 56) still works and defaults to main hand slot (slot 0).
   */
