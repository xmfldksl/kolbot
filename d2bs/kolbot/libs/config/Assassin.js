...
function LoadConfig () {
  ...
  */
   ...
   * GOOD: Config.AttackSkill[1] = [sdk.skills.FireBlast, 0];   // cast FireBlast using main hand slot
   * GOOD: Config.AttackSkill[1] = [sdk.skills.DeathSentry, 1]; // cast DeathSentry using swap slot
   * GOOD: Config.AttackSkill[1] = [251, 0];                    // numeric skillId with explicit slot
   * NOTE: Single number format (e.g. = 251) still works and defaults to main hand slot (slot 0).
   */
